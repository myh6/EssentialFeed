...
class LocalFeedImageDataFromCacheUseCaseTests: XCTestCase {
    ...
    private func expect(_ sut: LocalFeedImageDataLoader, toCompleteWith expectedResult: FeedImageDataStore.RetrievalResult, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
