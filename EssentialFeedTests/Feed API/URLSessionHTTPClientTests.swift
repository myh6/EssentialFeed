...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    private func resultValuesFor(_ values: (data: Data?, response: URLResponse?, error: Error?), taskHandler: (HTTPClientTask) -> Void = { _ in }, file: StaticString = #file, line: UInt = #line) -> (data: Data, response: HTTPURLResponse)? {
    ...
    private class URLProtocolStub: URLProtocol {
        private struct Stub {
            ...
            let error: Error?
            let requestedObserver: ((URLRequest) -> Void)?
        }
        ...
        static func stub(data: Data?, response: URLResponse?, error: Error?) {
            stub = Stub(data: data, response: response, error: error, requestedObserver: nil)
        }
        
        static func observerRequests(observer: @escaping (URLRequest) -> Void) {
            stub = Stub(data: nil, response: nil, error: nil, requestedObserver: observer)
        }
        ...
        override func startLoading() {
            ...
            stub.requestedObserver?(request)
        }
