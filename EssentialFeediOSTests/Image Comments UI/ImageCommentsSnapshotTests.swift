...
class ImageCommentsSnapshotTests: XCTestCase {
    ...
    func test_listWithComments() {
        ...
        assert(snapshot: sut.snapshot(for: .iPhone13(style: .light, contentSize: .extraLarge)), named: "IMAGE_COMMENTS_light_ExtraLarge")
        assert(snapshot: sut.snapshot(for: .iPhone13(style: .dark, contentSize: .extraLarge)), named: "IMAGE_COMMENTS_dark_ExtraLarge")
    }
